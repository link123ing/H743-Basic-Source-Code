...
uint32_t g_back_color  = 0x00000000;    /* 背景色 */


/* 根据不同的颜色格式,定义帧缓存数组 */

uint16_t (*ltdc_lcd_framebuf)[480] = (uint16_t (*)[480])0XC0000000;  /* 定义最大屏分辨率时,LCD所需的帧缓存数组大小 */
