...
/* LCD的画笔颜色和背景色 */
uint32_t g_point_color = 0x000000;    /* 画笔颜色 */
uint32_t g_back_color  = 0xFFFFFF;    /* 背景色 */


/* 根据不同的颜色格式,定义帧缓存数组 */

uint32_t ltdc_lcd_framebuf[1024][600] __attribute__((section(".bss.ARM.__at_0XC0000000")));  /* 定义最大屏分辨率时,LCD所需的帧缓存数组大小 */
...
void LCD_Init(void)
{
    ...
    lcdltdc.pixsize = 3;            /* RGB888每个像素占3个字节 */
