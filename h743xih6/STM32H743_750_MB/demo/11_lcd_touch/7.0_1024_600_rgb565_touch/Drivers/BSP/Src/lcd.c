...
uint16_t ltdc_lcd_framebuf[1024][600] __attribute__((section(".bss.ARM.__at_0XC0000000")));  /* 定义最大屏分辨率时,LCD所需的帧缓存数组大小 */

_ltdc_dev lcdltdc;                         /* 管理LCD LTDC的重要参数 */

/**
 * @brief       rgb888相对rgb565多余引脚初始化，防止显示出错，只在rgb565时使用
 * @param       无
 * @retval      无
 */
static void LCD_IO_Init(void)
{
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_8|GPIO_PIN_7|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    HAL_GPIO_WritePin(GPIOJ, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_8|GPIO_PIN_7|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14, GPIO_PIN_RESET);  
}
...
void LCD_Init(void)
{
    ...
    lcdltdc.pixsize = 2;            /* RGB565每个像素占3个字节 */
    
    lcdltdc.width = lcdltdc.pwidth;
    lcdltdc.height = lcdltdc.pheight;
    
    LCD_Display_Dir(0);             /* 默认横屏 */
