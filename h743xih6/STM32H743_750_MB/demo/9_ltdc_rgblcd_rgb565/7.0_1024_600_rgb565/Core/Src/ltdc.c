...
void MX_LTDC_Init(void)
{
  ...
  /* USER CODE BEGIN LTDC_Init 2 */
    __HAL_LTDC_ENABLE_IT(&hltdc, LTDC_IT_LI);           /* Ê¹ÄÜDMA2D */
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  */
    ...
    */
    ...
    /* LTDC interrupt Init */
    HAL_NVIC_SetPriority(LTDC_IRQn, 2, 2);
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_15|GPIO_PIN_12|GPIO_PIN_11|GPIO_PIN_10
                          |GPIO_PIN_9|GPIO_PIN_0|GPIO_PIN_8|GPIO_PIN_7
                          |GPIO_PIN_6|GPIO_PIN_1|GPIO_PIN_5|GPIO_PIN_2
                          |GPIO_PIN_3|GPIO_PIN_4);
