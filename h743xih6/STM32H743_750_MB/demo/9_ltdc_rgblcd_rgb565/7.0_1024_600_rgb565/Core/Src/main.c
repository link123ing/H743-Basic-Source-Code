...
int main(void)
{
  ...
  while (1)
  {
      ...
      LCD_Draw_Vline(309,20,180,MAGENTA);
      LCD_Draw_Vline(310,20,180,MAGENTA);
      LCD_Draw_Vline(311,20,180,MAGENTA);
      HAL_Delay(500);
      
      LCD_Draw_Line(220,20,400,200,BLUE);      
      LCD_Draw_Line(400,20,220,200,BLUE);
      HAL_Delay(500);
      ...
      LCD_Show_String(420,375,400,16,16,"LTDC_LCD_RGB565",RED);
      LCD_Show_String(420,395,400,12,12,"AC6.16 & (-O3)",RED);
      HAL_Delay(500);

      LCD_Clear(WHITE);      
      LCD_Fill_Color(112,60,912-1,540-1,gImage_qyc);  
      HAL_Delay(2000);
      num++;
