...
///**
// * @brief       SPI速度设置函数
// * @note        SPI速度=PLL1Q/分频系数(PLL1Q时钟设置为120Mhz)
// * @param       speed   : SPI1时钟分频系数
//                        取值为SPI_BAUDRATEPRESCALER_2~SPI_BAUDRATEPRESCALER_256
// * @retval      无
// */
// 
...
//    hspi2.Instance->CFG1&=~(0X7<<28);               /* 位30-28清零，用来设置波特率 */
//    hspi2.Instance->CFG1|= speed;                   /* 设置SPI速度 */
