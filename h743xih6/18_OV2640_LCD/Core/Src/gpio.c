...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DCMI_SCL_Pin|DCMI_SDA_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CT_SCL_GPIO_Port, CT_SCL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : DCMI_SCL_Pin */
  GPIO_InitStruct.Pin = DCMI_SCL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(DCMI_SCL_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : DCMI_SDA_Pin */
  ...
  /*Configure GPIO pin : OV2640_RST_Pin */
  ...
  /*Configure GPIO pin : OV2640_PWDN_Pin */
  ...
  /*Configure GPIO pin : CP_INT_Pin */
  GPIO_InitStruct.Pin = CP_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CP_INT_GPIO_Port, &GPIO_InitStruct);
